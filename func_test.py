...
def plot_data(_fpga, _channels):
    ...
    #ax1.set_ylim(0, 1000)
    #ax2.set_ylim(0, 6*10**13)
    #ax3.set_ylim(0, 6*10**13)
    ax2.set_xlim(0,bw)
    ax2.set_ylim(50, 150)
    ax3.set_xlim(0,bw)
    ax3.set_ylim(50, 150)
...
def function():
   ...
   # A2 = struct.unpack('>8192Q', fpga.read('A2', 8192*8))       #esto esta raro...toy leyendo la mitad de los datos que debiese tener
    #B2 = struct.unpack('>8192Q', fpga.read('B2', 8192*8))
    #AB_re = struct.unpack('>8192Q', fpga.read('AB_re', 8192*8))
    #AB_im = struct.unpack('>8192Q', fpga.read('AB_im', 8192*8))
