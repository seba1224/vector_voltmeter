#
# Created by System Generator     Fri May 10 11:52:28 2019
#
...
namespace eval ::xilinx::dsptool::iseproject::param {
    ...
    set ProjectFiles {
        {{testing2_cw.vhd} -view All}
        {{testing2.vhd} -view All}
        {{testing2_cw.ucf}}
        {{testing2_cw.xdc}}
        ...
        {{/home/seba/Documents/Untitled_Folder/scripts/vector_voltmeter/models/dec2/part2_dec4/testing2.slx}}
    }
    set TopLevelModule {testing2_cw}
    set SynthesisConstraintsFile {testing2_cw.xcf}
