...
data(3+4,2) = 372*10^(-8);
data(3+1+4,2) = 372*10^(-8);
data(3+2+4,2) = 372*10^(-8);
data(3+3+4,2) = 372*10^(-8);
data(3+256+4, 2) = 209*10^(-8);
data(3+256+1+4, 2) = 209*10^(-8);
data(3+256+2+4, 2) = 209*10^(-8);
data(3+256+3+4, 2) = 209*10^(-8);
data(3+512+4, 2) = 582*10^(-8);
data(3+512+1+4, 2) = 582*10^(-8);
data(3+512+2+4, 2) = 582*10^(-8);
data(3+512+3+4, 2) = 582*10^(-8);
data(3+256*3+4, 2) = 52*10^(-8);
data(3+256*3+1+4, 2) = 52*10^(-8);
data(3+256*3+2+4, 2) = 52*10^(-8);
data(3+256*3+3+4, 2) = 52*10^(-8);
