...
def animate(_):
    snap_data = np.fromstring(fpga.snapshot_get('snapshot', man_trig=True, man_valid=True)['data'], dtype='>i1') # 'snapshot' string here must be the name of your snapshot block in the simulink model
