...
IP = '192.168.1.12'
bof = 'voltmeter_bw8_2kh.bof'#'bom_dia_2019_Jan_21_1614.bof'
...
def animate(_):
    snap_data = np.fromstring(fpga.snapshot_get('adcsnap0', man_trig=True, man_valid=True)['data'], dtype='>i1') # 'snapshot' string here must be the name of your snapshot block in the simulink model
